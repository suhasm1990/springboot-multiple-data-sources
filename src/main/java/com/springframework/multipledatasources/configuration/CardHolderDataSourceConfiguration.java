...
@Configuration
@EnableJpaRepositories(basePackages = "com.springframework.multipledatasources.repository.cardholder",
...
public class CardHolderDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean cardHolderEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.springframework.multipledatasources.model.cardholder")
                .build();
    }
