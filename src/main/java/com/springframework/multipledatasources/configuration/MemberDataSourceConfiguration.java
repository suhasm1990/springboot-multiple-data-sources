...
@EnableJpaRepositories(basePackages = "com.springframework.multipledatasources.repository.member",
...
public class MemberDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean memberEntityManagerFactory(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.springframework.multipledatasources.model.member")
                .build();
    }
